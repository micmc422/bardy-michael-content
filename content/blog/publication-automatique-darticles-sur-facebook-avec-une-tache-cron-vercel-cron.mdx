...
<Faq faqTitle="FAQ : automatisation publication rÃ©seaux sociaux" faq={[
  { title: "Comment automatiser la publication d'articles sur Facebook et LinkedIn ?", content: "Un systÃ¨me serverless avec Vercel Cron exÃ©cute une tÃ¢che quotidienne qui publie les articles rÃ©cents via les APIs Facebook (Graph API) et LinkedIn (UGC). Les mÃ©tadonnÃ©es OpenGraph enrichissent automatiquement le post." },
  { title: "Pourquoi faut-il renouveler le token Facebook et comment le faire automatiquement ?", content: "Le token Facebook expire au bout d'environ 60 jours. Une tÃ¢che cron quotidienne vÃ©rifie et renouvelle le token via l'API Facebook avant expiration, le stocke dans Vercel Edge Config pour Ã©viter toute interruption." },
  { title: "Quels sont les avantages de l'automatisation pour mon portfolio ?", content: "Gain de temps, prÃ©sence rÃ©guliÃ¨re et optimisÃ©e sur les rÃ©seaux, enrichissement des publications avec titres et images, et amÃ©lioration du SEO grÃ¢ce aux backlinks et Ã  la visibilitÃ© accrue." },
  { title: "Comment gÃ©rer les erreurs si une publication Ã©choue ?", content: "Le systÃ¨me est conÃ§u avec des blocs try/catch pour intercepter les erreurs d'API. Les Ã©checs sont loguÃ©s pour suivi, et un fallback peut Ãªtre ajoutÃ© pour les cas rÃ©currents. Le systÃ¨me reste robuste et Ã©volutif." }
]} />
